...
gboolean restart_required = FALSE;
  ...
  <xsl:for-each select="./dtconfiglist/dtconfig[@prefs='lighttable' and not(@section='slideshow')]">
  ...
  <xsl:for-each select="./dtconfiglist/dtconfig[@prefs='lighttable' and @section='slideshow']">
    <xsl:apply-templates select="." mode="tab_block"/>
  </xsl:for-each>
